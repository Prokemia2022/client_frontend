		...
		<SampleModal issampleModalvisible={issampleModalvisible} setissampleModalvisible={setissampleModalvisible}/>
			<Flex p='2' direction='column' gap='2' className={styles.productsection1}>
				...
				<Flex direction='column' gap='2'>
					<Button bg='#009393' borderRadius='0' border='1px solid #000' p='1' color='#fff'>Edit Product</Button>
					<Button bg='#fff' borderRadius='0' border='1px solid #000' p='1'>List as short on Expiry</Button>
					<Button bg='#fff' color='red' borderRadius='0' border='1px solid red' p='1'>Delete Product</Button>
				</Flex>
			</Flex>
		</Flex>
	)
