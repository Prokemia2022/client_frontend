...
export default function Body(props){
    ...
    */}
    ...
    const new_product_url = `/products/product/new?company_name=${company_name}&email=${email}&lister_id=${lister_id}&acc_type=manufacturer&is_verified=${is_verified}&is_suspended=${is_suspended}`;
    return (
        <Box gap='2'>
            ...
            <Td>
                <Menu >
                    ...
                    <MenuList>
                        ...
                        <MenuItem 
                            onClick={(()=>{router.push(`/products/product/edit/${item?._id}?uid=${lister_id}&acc_type='manufacturer'`)})}
                        >
                            Edit Product
                        </MenuItem>
                        <MenuItem 
