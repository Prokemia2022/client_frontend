...
export default function Settings({client_data,set_refresh_data,is_complete_profile}) {
  ...
  return (
    <Box>
        <Delete_Account_Modal is_delete_account_Modalvisible={is_delete_account_Modalvisible} set_is_delete_account_Modalvisible={set_is_delete_account_Modalvisible} client_data={client_data} acc_type='distributors'/>
        <Box>
