...
function Settings(){
	...
	return(
		<Flex p='2' direction='column' gap='2' w='100%' overflowY='scroll' h='100vh'>
			<Text fontSize='34px' textDecoration='3px solid underline #009393' fontWeight='bold'>Settings</Text>
			{edit ?
				...
				<Flex gap='3' >
					...
					<Flex direction='column' gap='3' w='100%'>
						<Text bg='#eee' p='1' borderRadius='5' fontSize='24px' fontWeight='bold' color='#009393'>Manufacturer Name</Text>
						<Text bg='#eee' p='1' borderRadius='5'>manufacturer@gmail.com</Text>
				...
				<Flex direction='column' gap='2'>
					...
					{active && currentValue === 'settings' ? 
						...
						<Flex gap='2' direction='column'>
							...
							<Button bg='#ff' border='1px solid #000' onClick={(()=>{setAccount('manufacturer')})}>Switch to Manufacturer Account</Button>
						</Flex>
						</>
						:
						null
		...
		<Flex gap='3' direction='column'>
			...
			<Flex direction='column' gap='3' w='100%'>
					<Flex direction='column'>
						<Text>Name</Text>
						<Input type='text' value='Manufafcturer Name' variant='filled'/>
					</Flex>
					<Flex direction='column'>
						<Text>Email</Text>
						<Input type='email' value='manufacturer@gmail.com' variant='filled'/>
					</Flex>
					<Flex direction='column'>
						<Text>Mobile</Text>
